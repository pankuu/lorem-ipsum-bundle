...
namespace KnpU\LoremIpsumBundle\Teste\Controller;
...
class IpsumApiControllerTest extends TestCase
{
    public function testIndex()
    {
        ...
        $client = new \Symfony\Bundle\FrameworkBundle\Client($kernel);
...
class KnpULoremIpsumControllerKernel extends Kernel
{
    ...
    {
        $routes->import('../../src/Resources/config/routes.xml', '/api');
    }
